...
public class JwtTokenUtil implements Serializable {
    ...
    public static final long JWT_TOKEN_VALIDITY = 600L;
    public static final long JWT_REFRESH_TOKEN_VALIDITY = 600L;
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject, Long time) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + (1 * 60 * 1000) * time))
